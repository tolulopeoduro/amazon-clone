    ...
    return (
        <div ref = {NavRight} style ={{width : window.clientWidth}} className = {classes.TopNavRight}>
            <div className = {classes.Language}>
                <img className = {classes.Flag} height = "18px" src = {"/images/Flag_of_the_United_States.svg"} />
                <img className = {classes.Arrow} height = "4px" src = {"/images/down-arrow.svg"}/>
            </div>
            <div className = {classes.Accounts}>
                ...
                <img style = {{display : "inline"}} className = {classes.Arrow} height = "4px" src = {"/images/down-arrow.svg"}/>
            </div>
